<template>
	<div class="detail" v-if="detail.title">
		...
		<div class="content">
		  <div class="header clear"><h2><img :src="detail.detail.auth_icon"/></h2><p>作者名字: {{detail.detail.auth}}</p></div>
		  <div class="cont">
		    <h3>{{detail.title}}</h3>
		    <div class="time"><p>{{detail.time | date}}<span><img src="../assets/img/zan.png"/></span></p></div>
